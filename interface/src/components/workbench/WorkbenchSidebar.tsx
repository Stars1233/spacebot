...
export function WorkbenchSidebar({
	...
	return (
		<aside className="flex h-full w-[240px] flex-shrink-0 flex-col overflow-hidden rounded-2xl border border-app-line bg-app">
	...
	return (
		<div className="mb-1">
			<div className="flex items-center gap-1.5 px-3 py-0.5 text-tiny text-ink-faint">
				...
				<span
					className="flex-1 truncate font-medium text-ink-dull"
...
function WorkerRow({
	...
	return (
		<button
			...
			className="group flex w-full items-start gap-2 px-3 py-1.5 text-left hover:bg-app-selected/40"
			title={taskText}
		>
			<span
				className={cx(
			...
			<span className="min-w-0 flex-1">
				<span className="block truncate text-xs text-ink group-hover:text-ink">
					{taskText}
				</span>
